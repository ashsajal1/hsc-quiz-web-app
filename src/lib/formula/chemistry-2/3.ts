export const chemistry3 = [
  ...
  },
  {
    ...
    formula:
      "Find mole ratio of elements, then simplify to smallest whole numbers.",
    description:
      "Determines simplest whole number ratio of atoms in a compound.",
  },
  {
    topic: "chemistry",
    chapter: "Stoichiometric Chemistry",
  ...
  },
  {
    ...
    formula:
      "Reactant which produces least product amount limits reaction extent.",
    description: "Determines maximum amount of product formed.",
  },
  {
    topic: "chemistry",
    chapter: "Stoichiometric Chemistry",
