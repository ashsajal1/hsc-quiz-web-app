          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                <li>Each card shows a physics formula and its scrambled name</li>
                <li>Click on the letters in the correct order to form the formula name</li>
                <li>Use the hint button (?) to see the formula description</li>
                <li>If you make a mistake, use the Reset button to start over</li>
